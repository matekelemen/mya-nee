...
# --- Internal Imports ---
from myanee.utilities import URLUtilities, chunks, SOURCE_DIR
...
class TestUtilities(unittest.TestCase):
    ...
    def test_isURL(self):
        ...
        for string in validURLs:
            self.assertTrue(URLUtilities.isURL(string), msg=string)

        for string in invalidURLs:
            self.assertFalse(URLUtilities.isURL(string), msg=string)
